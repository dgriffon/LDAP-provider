...
public class AbstractNameClassPairCallbackHandler {
    ...
    AbstractNameClassPairCallbackHandler(UserConfig userConfig, GroupConfig groupConfig) {
     ...
     * @return
     */
     Properties attributesToJahiaProperties(Attributes attributes, boolean isUser) {
